...
@Component({
    selector: 'app-ba-own-projects',
    templateUrl: 'ba-own-projects.component.html',
    styleUrls: ['./ba-own-projects.component.scss']
})

export class BaOwnProjectsComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    getAllProjects = () => {
        this.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.datatableService.getTableData(dataTablesParameters, 'datatable/getOwnProjectsDatatableBa').subscribe(resp => {
