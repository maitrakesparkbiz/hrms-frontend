...
@Component({
    selector: 'app-project-jr-ba-approved',
    templateUrl: './project-jr-ba-approved.component.html',
    styleUrls: ['./project-jr-ba-approved.component.scss']
})

export class ProjectJrBaApprovedComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    getAllProjects() {
        this.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.datatableService.getTableData(dataTablesParameters,
                    'datatable/getAllApprovedProjectsJrBaDataTable').subscribe(resp => {
    ...
    checkone(id) {
        ...
        if (this.allcheck_id_count === 1) {
            ...
            this.getApprovedProjectComments({ project_id: id, user1: this.projectDetails.emp_id, user2: this.userId });
        }
    }
