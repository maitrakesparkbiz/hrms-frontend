...
@Component({
    selector: 'app-ba-tl-closed-projects',
    templateUrl: './ba-tl-closed-projects.component.html',
    styleUrls: ['./ba-tl-closed-projects.component.scss']
})

export class BaTlClosedProjectsComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    ngOnInit() {
        this.route.data.subscribe(
            (res) => {
                if(res.is_ba){
                    this.link = 'getAllClosedProjectsDatatableBa';
                }else{
                    this.link = 'getAllClosedProjectsDatatableBaTl';
                }
            }
        );
        this.getAllClosedProjects();
    }
    ...
    getAllClosedProjects = () => {
        this.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.datatableService.getClosedTableData(dataTablesParameters, 'datatable/'+this.link).subscribe(resp => {
