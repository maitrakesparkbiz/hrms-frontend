...
@Component({
    templateUrl: './ba-tl-own-projects.component.html',
    styleUrls: ['./ba-tl-own-projects.component.scss']
})

export class BaTlOwnProjectsComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    getAllProjects = () => {
        this.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.datatableService.getTableData(dataTablesParameters, 'datatable/getOwnProjectsDatatableBaTl').subscribe(resp => {
