...
@Component({
    styleUrls: ['./today-interview.component.scss'],
    templateUrl: 'today-interview.component.html'
})

export class TodayInterviewComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    getAllJobApplications = () => {
        this.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.datatableService.getTableData(dataTablesParameters, 'datatable/getAllJobApplicationsTodayInt').subscribe(resp => {
